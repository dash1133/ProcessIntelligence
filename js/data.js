...
const ALERTS = [
  { id: 1, type: "cost_overrun", priority: "critical", category: "Cost Overrun",
    title: "ProctorOne Rate Spike — +18% MoM",
    detail: "Live online proctoring vendor ProctorOne (64% of delivery volume) issued a 14% rate hike + new $0.42/test surcharge effective May 1. Contract auto-renews June 30.",
    metric: "+$2.1M annualized", impact: "+0.6pp on Cost-to-Revenue",
    action: "Issue RFP to ExamGuard and SecureProctor by May 5 (bids already 9–12% below). Parallel-track internal AI-proctoring PoC for 25–30% of volume.",
    categories: ["Test Delivery"],
    dateGenerated: "Apr 28 · 6:02 AM", audience: "Daniel Reyes", audienceType: "user", frequency: "Real-time", schedule: "On vendor rate movement > 5% MoM" },

  { id: 2, type: "customer_risk", priority: "critical", category: "Customer Risk",
    title: "Northstar University Renewal at Risk — GradPath",
    detail: "Northstar (47 campuses, 8.2% of GradPath B2B revenue) flagged renewal at-risk: pricing 14% above peers and 4.2-day score SLA vs. competitor's 2.5-day. Re-bid due May 30.",
    metric: "$8.4M ACV at risk", impact: "Signal effect on 6 similar accounts in re-bid cycle",
    action: "Counter-bid by May 22 with AI scoring mix (70/30) — drops cost-per-response $1.85 → $1.20 and SLA to 2.0 days.",
    categories: ["Test Delivery", "Scoring Operations"],
    dateGenerated: "Apr 28 · 9:14 AM", audience: "Daniel Reyes", audienceType: "user", frequency: "Real-time", schedule: "On flagged renewals > $5M ACV" },

  { id: 3, type: "process_health", priority: "high", category: "Process Health",
    title: "Scoring SLA Breach — 4.2-Day CR Backlog",
    detail: "Constructed-response queue at 4.2 days vs. 2.0-day SLA. Rater pool down 22% YoY, volume up 14%. Breaches contract SLA for 6 enterprise accounts within 9 days.",
    metric: "4.2d vs 2.0d SLA", impact: "$320K in penalties · NPS hit",
    action: "Route 60% of CR responses through AI scoring with 5% human spot-check. Clears backlog in ~5 days; structural −$0.65/response.",
    categories: ["Scoring Operations"],
    dateGenerated: "Apr 28 · 7:00 AM", audience: "Scoring Ops Leads", audienceType: "group", frequency: "Daily", schedule: "On queue depth > 3 days" },
];
